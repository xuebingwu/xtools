...
void help()
{
    ...
    "   -c1 <integer>  key column in file1, default 1 (first)\n"
    "   -c2 <integer>  key column in file2, default 1 (first)\n"
	"   -intersect     (default) output file1 lines with shared key in file2) \n"
	"   -subtract      output file1 lines without shared key in file2)\n"
	"   -merge         output file1 and file2 side by side\n"
